...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo, (key, g) => new {DeptNo = key, Count = g.Count()}).ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Join(grades, e => true, g => true, (emp, salgrade) => new { emp.EName, emp.Sal, salgrade.Grade, salgrade.Losal,salgrade.Hisal}).Where(r => r.Sal >= r.Losal && r.Sal <= r.Hisal).ToList();
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(e => new {DeptNo = e.Key, AvgSal = e.Average(e => e.Sal)}).OrderByDescending(e => e.AvgSal).ToList(); 
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(i => i.DeptNo == e.DeptNo).Average(e => e.Sal)).Select(e => e.EName).ToList();
